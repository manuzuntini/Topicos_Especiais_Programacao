...
llm = ChatGroq(temperature=0.7,
               groq_api_key='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',
...
write_task = Task(
    ...
    expected_output = f"A comprehensive 4 paragraphs blog on {topic} in markdown format.Mas em portuges brasil",
    tools = [search_tool],
    agent = researcher,
